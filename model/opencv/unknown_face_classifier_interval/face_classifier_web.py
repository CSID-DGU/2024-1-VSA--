#!/usr/bin/env python3
# python face_classifier_web.py 0
...
app = Flask(__name__)
fc = None  # FaceClassifier 객체 전역 참조
pdb = None  # PersonDB 객체 전역 참조
...
if __name__ == '__main__':
    ...
    fc = FaceClassifier(args.threshold, args.resize_ratio)
